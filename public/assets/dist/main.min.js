...
"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");var _slicedToArray2=_interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));var _typeof2=_interopRequireDefault(require("@babel/runtime/helpers/typeof"));var _regenerator=_interopRequireDefault(require("@babel/runtime/regenerator"));var _asyncToGenerator2=_interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator"));function formEncodedPOST(_x,_x2){return _formEncodedPOST.apply(this,arguments);}function _formEncodedPOST(){_formEncodedPOST=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee33(url,data){var body,req,res;return _regenerator["default"].wrap(function _callee33$(_context33){while(1){switch(_context33.prev=_context33.next){case 0:body=new URLSearchParams();Object.keys(data).forEach(function(key){return body.append(key,data[key]);});_context33.next=4;return fetch(url,{method:'POST',headers:{"Content-Type":"application/x-www-form-urlencoded"},body:body,redirect:'follow'});case 4:req=_context33.sent;_context33.next=7;return req.json();case 7:res=_context33.sent;return _context33.abrupt("return",res);case 9:case"end":return _context33.stop();}}},_callee33);}));return _formEncodedPOST.apply(this,arguments);}window.app=new Vue({el:'#app',data:{session:false,loaded:false},computed:{url_garden_id:function url_garden_id(){return document.location.pathname.split("/").filter(function(r){return r.length===24;})[0];}},methods:{popup:function popup(type){console.log(type);},getUserSession:function(){var _getUserSession=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(){var req,res;return _regenerator["default"].wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return fetch("/api/session");case 2:req=_context.sent;_context.next=5;return req.json();case 5:res=_context.sent;return _context.abrupt("return",res);case 7:case"end":return _context.stop();}}},_callee);}));function getUserSession(){return _getUserSession.apply(this,arguments);}return getUserSession;}()},created:function(){var _created=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(){var _this=this;return _regenerator["default"].wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:this.getUserSession().then(function(res){_this.session=res.session||false;_this.loaded=true;});case 1:case"end":return _context2.stop();}}},_callee2,this);}));function created(){return _created.apply(this,arguments);}return created;}()});/*
 * # Fomantic UI - 2.8.4
