...
},{"./arrayWithHoles":2,"./iterableToArrayLimit":5,"./nonIterableRest":6,"./unsupportedIterableToArray":9}],8:[function(require,module,exports){
...
},{"regenerator-runtime":11}],11:[function(require,module,exports){
/**
...
"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");var _slicedToArray2=_interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));var _typeof2=_interopRequireDefault(require("@babel/runtime/helpers/typeof"));var _regenerator=_interopRequireDefault(require("@babel/runtime/regenerator"));var _asyncToGenerator2=_interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator"));function formEncodedPOST(_x,_x2){return _formEncodedPOST.apply(this,arguments);}function _formEncodedPOST(){_formEncodedPOST=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee35(url,data){var body,req,res;return _regenerator["default"].wrap(function _callee35$(_context35){while(1){switch(_context35.prev=_context35.next){case 0:body=new URLSearchParams();Object.keys(data).forEach(function(key){return body.append(key,data[key]);});_context35.next=4;return fetch(url,{method:'POST',headers:{"Content-Type":"application/x-www-form-urlencoded"},body:body,redirect:'follow'});case 4:req=_context35.sent;_context35.next=7;return req.json();case 7:res=_context35.sent;return _context35.abrupt("return",res);case 9:case"end":return _context35.stop();}}},_callee35);}));return _formEncodedPOST.apply(this,arguments);}window.app=new Vue({el:'#app',data:{session:false,loaded:false},computed:{url_garden_id:function url_garden_id(){return this.getLastURLPart();},url_plant_id:function url_plant_id(){return this.getLastURLPart();}},methods:{popup:function popup(type){console.log(type);},getUserSession:function(){var _getUserSession=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(){var req,res;return _regenerator["default"].wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return fetch("/api/session");case 2:req=_context.sent;_context.next=5;return req.json();case 5:res=_context.sent;return _context.abrupt("return",res);case 7:case"end":return _context.stop();}}},_callee);}));function getUserSession(){return _getUserSession.apply(this,arguments);}return getUserSession;}(),getLastURLPart:function getLastURLPart(){return document.location.pathname.split("/").pop();}},created:function(){var _created=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(){var _this=this;return _regenerator["default"].wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:this.getUserSession().then(function(res){_this.session=res.session||false;_this.loaded=true;});case 1:case"end":return _context2.stop();}}},_callee2,this);}));function created(){return _created.apply(this,arguments);}return created;}()});/*
 * # Fomantic UI - 2.8.4
...
addResult(fuzzyResults,content);}}});});$.merge(exactResults,fuzzyResults);$.merge(results,exactResults);return results;}},exactSearch:function exactSearch(query,term){query=query.toLowerCase();term=term.toLowerCase();return term.indexOf(query)>-1;},fuzzySearch:function fuzzySearch(query,term){var termLength=term.length,queryLength=query.length;if(typeof query!=='string'){return false;}query=query.toLowerCase();term=term.toLowerCase();if(queryLength>termLength){return false;}if(queryLength===termLength){return query===term;}search:for(var characterIndex=0,nextCharacterIndex=0;characterIndex<queryLength;characterIndex++){var queryCharacter=query.charCodeAt(characterIndex);while(nextCharacterIndex<termLength){if(term.charCodeAt(nextCharacterIndex++)===queryCharacter){continue search;}}return false;}return true;},parse:{response:function response(_response,searchTerm){if(Array.isArray(_response)){var o={};o[fields.results]=_response;_response=o;}var searchHTML=module.generateResults(_response);module.verbose('Parsing server response',_response);if(_response!==undefined){if(searchTerm!==undefined&&_response[fields.results]!==undefined){module.addResults(searchHTML);module.inject.id(_response[fields.results]);module.write.cache(searchTerm,{html:searchHTML,results:_response[fields.results]});module.save.results(_response[fields.results]);}}}},cancel:{query:function query(){if(module.can.useAPI()){$module.api('abort');}}},has:{minimumCharacters:function minimumCharacters(){var searchTerm=module.get.value(),numCharacters=searchTerm.length;return numCharacters>=_settings5.minCharacters;},results:function results(){if($results.length===0){return false;}var html=$results.html();return html!='';}},clear:{cache:function cache(value){var cache=$module.data(metadata.cache);if(!value){module.debug('Clearing cache',value);$module.removeData(metadata.cache);}else if(value&&cache&&cache[value]){module.debug('Removing value from cache',value);delete cache[value];$module.data(metadata.cache,cache);}}},read:{cache:function cache(name){var cache=$module.data(metadata.cache);if(_settings5.cache){module.verbose('Checking cache for generated html for query',name);return(0,_typeof2["default"])(cache)=='object'&&cache[name]!==undefined?cache[name]:false;}return false;}},create:{categoryResults:function categoryResults(results){var categoryResults={};$.each(results,function(index,result){if(!result.category){return;}if(categoryResults[result.category]===undefined){module.verbose('Creating new category of results',result.category);categoryResults[result.category]={name:result.category,results:[result]};}else{categoryResults[result.category].results.push(result);}});return categoryResults;},id:function id(resultIndex,categoryIndex){var resultID=resultIndex+1,// not zero indexed
...
if((0,_typeof2["default"])(animation)=='object'){return $.extend(true,{},$.fn.transition.settings,animation);}// all arguments provided
...
else if((0,_typeof2["default"])(duration)=='object'){return $.extend({},$.fn.transition.settings,duration,{animation:animation});}// duration is actually callback
...
onRefresh:function onRefresh(){},metadata:{src:'src'},className:{fixed:'fixed',placeholder:'constraint',visible:'visible'},error:{method:'The method you called is not defined.',visible:'Element is hidden, you must call refresh after element becomes visible'}};})(jQuery,window,document);!function(s,n){"object"==(typeof exports==="undefined"?"undefined":(0,_typeof2["default"])(exports))&&"undefined"!=typeof module?n(exports):"function"==typeof define&&define.amd?define(["exports"],n):n((s=s||self).timeago={});}(void 0,function(s){"use strict";var a=["second","minute","hour","day","week","month","year"];function n(s,n){if(0===n)return["just now","right now"];var e=a[Math.floor(n/2)];return 1<s&&(e+="s"),[s+" "+e+" ago","in "+s+" "+e];}var t=["秒","分钟","小时","天","周","个月","年"];function e(s,n){if(0===n)return["刚刚","片刻后"];var e=t[~~(n/2)];return[s+" "+e+"前",s+" "+e+"后"];}function u(s,n){i[s]=n;}function r(s){return i[s]||i.en_US;}var i={},m=[60,60,24,7,365/7/12,12];function o(s){return s instanceof Date?s:!isNaN(s)||/^\d+$/.test(s)?new Date(parseInt(s)):(s=(s||"").trim().replace(/\.\d+/,"").replace(/-/,"/").replace(/-/,"/").replace(/(\d)T(\d)/,"$1 $2").replace(/Z/," UTC").replace(/([+-]\d\d):?(\d\d)/," $1$2"),new Date(s));}function d(s,n){for(var e=s<0?1:0,a=s=Math.abs(s),t=0;s>=m[t]&&t<m.length;t++){s/=m[t];}return(0===(t*=2)?9:1)<(s=Math.floor(s))&&(t+=1),n(s,t,a)[e].replace("%s",s.toString());}function c(s,n){return((n?o(n):new Date())-o(s))/1e3;}var l="timeago-id";function h(s){return parseInt(s.getAttribute(l));}var g={},f=function f(s){clearTimeout(s),delete g[s];};function p(s,n,e,a){f(h(s));var t=a.relativeDate,u=a.minInterval,r=c(n,t);s.innerText=d(r,e);var i,o=setTimeout(function(){p(s,n,e,a);},Math.min(1e3*Math.max(function(s){for(var n=1,e=0,a=Math.abs(s);s>=m[e]&&e<m.length;e++){s/=m[e],n*=m[e];}return a=(a%=n)?n-a:n,Math.ceil(a);}(r),u||1),2147483647));g[o]=0,i=o,s.setAttribute(l,i);}u("en_US",n),u("zh_CN",e);var b=[["ثانية","ثانيتين","%s ثوان","%s ثانية"],["دقيقة","دقيقتين","%s دقائق","%s دقيقة"],["ساعة","ساعتين","%s ساعات","%s ساعة"],["يوم","يومين","%s أيام","%s يوماً"],["أسبوع","أسبوعين","%s أسابيع","%s أسبوعاً"],["شهر","شهرين","%s أشهر","%s شهراً"],["عام","عامين","%s أعوام","%s عاماً"]];function v(s,n,e,a,t){var u=t%10,r=a;return 1===t?r=s:1==u&&20<t?r=n:1<u&&u<5&&(20<t||t<10)&&(r=e),r;}var y=v.bind(null,"секунду","%s секунду","%s секунды","%s секунд"),k=v.bind(null,"хвіліну","%s хвіліну","%s хвіліны","%s хвілін"),j=v.bind(null,"гадзіну","%s гадзіну","%s гадзіны","%s гадзін"),z=v.bind(null,"дзень","%s дзень","%s дні","%s дзён"),w=v.bind(null,"тыдзень","%s тыдзень","%s тыдні","%s тыдняў"),_=v.bind(null,"месяц","%s месяц","%s месяцы","%s месяцаў"),M=v.bind(null,"год","%s год","%s гады","%s гадоў");function q(s){var n=["۰","۱","۲","۳","۴","۵","۶","۷","۸","۹"];return s.toString().replace(/\d/g,function(s){return n[s];});}var S=[["w tej chwili","za chwilę"],["%s sekund temu","za %s sekund"],["1 minutę temu","za 1 minutę"],["%s minut temu","za %s minut"],["1 godzinę temu","za 1 godzinę"],["%s godzin temu","za %s godzin"],["1 dzień temu","za 1 dzień"],["%s dni temu","za %s dni"],["1 tydzień temu","za 1 tydzień"],["%s tygodni temu","za %s tygodni"],["1 miesiąc temu","za 1 miesiąc"],["%s miesięcy temu","za %s miesięcy"],["1 rok temu","za 1 rok"],["%s lat temu","za %s lat"],["%s sekundy temu","za %s sekundy"],["%s minuty temu","za %s minuty"],["%s godziny temu","za %s godziny"],["%s dni temu","za %s dni"],["%s tygodnie temu","za %s tygodnie"],["%s miesiące temu","za %s miesiące"],["%s lata temu","za %s lata"]];function T(s,n,e,a,t){var u=t%10,r=a;return 1===t?r=s:1==u&&20<t?r=n:1<u&&u<5&&(20<t||t<10)&&(r=e),r;}var N=T.bind(null,"секунду","%s секунду","%s секунды","%s секунд"),x=T.bind(null,"минуту","%s минуту","%s минуты","%s минут"),D=T.bind(null,"час","%s час","%s часа","%s часов"),I=T.bind(null,"день","%s день","%s дня","%s дней"),O=T.bind(null,"неделю","%s неделю","%s недели","%s недель"),W=T.bind(null,"месяц","%s месяц","%s месяца","%s месяцев"),$=T.bind(null,"год","%s год","%s года","%s лет");function J(s,n,e,a,t){var u=t%10,r=t%100;return 1==t?s:1==u&&11!=r?n:2<=u&&u<=4&&!(12<=r&&r<=14)?e:a;}var U=J.bind(null,"1 секунд","%s секунд","%s секунде","%s секунди"),A=J.bind(null,"1 минут","%s минут","%s минуте","%s минута"),C=J.bind(null,"сат времена","%s сат","%s сата","%s сати"),E=J.bind(null,"1 дан","%s дан","%s дана","%s дана"),B=J.bind(null,"недељу дана","%s недељу","%s недеље","%s недеља"),P=J.bind(null,"месец дана","%s месец","%s месеца","%s месеци"),R=J.bind(null,"годину дана","%s годину","%s године","%s година");function Z(s,n,e,a,t){var u=t%10,r=a;return 1===t?r=s:1==u&&20<t?r=n:1<u&&u<5&&(20<t||t<10)&&(r=e),r;}var F=Z.bind(null,"секунду","%s секунду","%s секунди","%s секунд"),G=Z.bind(null,"хвилину","%s хвилину","%s хвилини","%s хвилин"),H=Z.bind(null,"годину","%s годину","%s години","%s годин"),K=Z.bind(null,"день","%s день","%s дні","%s днів"),L=Z.bind(null,"тиждень","%s тиждень","%s тиждні","%s тижднів"),Q=Z.bind(null,"місяць","%s місяць","%s місяці","%s місяців"),V=Z.bind(null,"рік","%s рік","%s роки","%s років");var X=Object.freeze({__proto__:null,ar:function ar(s,n){if(0===n)return["منذ لحظات","بعد لحظات"];var e,a,t=(e=Math.floor(n/2),(a=s)<3?b[e][a-1]:3<=a&&a<=10?b[e][2]:b[e][3]);return["منذ "+t,"بعد "+t];},be:function be(s,n){switch(n){case 0:return["толькі што","праз некалькі секунд"];case 1:return[y(s)+" таму","праз "+y(s)];case 2:case 3:return[k(s)+" таму","праз "+k(s)];case 4:case 5:return[j(s)+" таму","праз "+j(s)];case 6:case 7:return[z(s)+" таму","праз "+z(s)];case 8:case 9:return[w(s)+" таму","праз "+w(s)];case 10:case 11:return[_(s)+" таму","праз "+_(s)];case 12:case 13:return[M(s)+" таму","праз "+M(s)];default:return["",""];}},bg:function bg(s,n){return[["току що","съвсем скоро"],["преди %s секунди","след %s секунди"],["преди 1 минута","след 1 минута"],["преди %s минути","след %s минути"],["преди 1 час","след 1 час"],["преди %s часа","след %s часа"],["преди 1 ден","след 1 ден"],["преди %s дни","след %s дни"],["преди 1 седмица","след 1 седмица"],["преди %s седмици","след %s седмици"],["преди 1 месец","след 1 месец"],["преди %s месеца","след %s месеца"],["преди 1 година","след 1 година"],["преди %s години","след %s години"]][n];},bn_IN:function bn_IN(s,n){return[["এইমাত্র","একটা সময়"],["%s সেকেন্ড আগে","%s এর সেকেন্ডের মধ্যে"],["1 মিনিট আগে","1 মিনিটে"],["%s এর মিনিট আগে","%s এর মিনিটের মধ্যে"],["1 ঘন্টা আগে","1 ঘন্টা"],["%s ঘণ্টা আগে","%s এর ঘন্টার মধ্যে"],["1 দিন আগে","1 দিনের মধ্যে"],["%s এর দিন আগে","%s এর দিন"],["1 সপ্তাহ আগে","1 সপ্তাহের মধ্যে"],["%s এর সপ্তাহ আগে","%s সপ্তাহের মধ্যে"],["1 মাস আগে","1 মাসে"],["%s মাস আগে","%s মাসে"],["1 বছর আগে","1 বছরের মধ্যে"],["%s বছর আগে","%s বছরে"]][n];},ca:function ca(s,n){return[["fa un moment","d'aquí un moment"],["fa %s segons","d'aquí %s segons"],["fa 1 minut","d'aquí 1 minut"],["fa %s minuts","d'aquí %s minuts"],["fa 1 hora","d'aquí 1 hora"],["fa %s hores","d'aquí %s hores"],["fa 1 dia","d'aquí 1 dia"],["fa %s dies","d'aquí %s dies"],["fa 1 setmana","d'aquí 1 setmana"],["fa %s setmanes","d'aquí %s setmanes"],["fa 1 mes","d'aquí 1 mes"],["fa %s mesos","d'aquí %s mesos"],["fa 1 any","d'aquí 1 any"],["fa %s anys","d'aquí %s anys"]][n];},de:function de(s,n){return[["gerade eben","vor einer Weile"],["vor %s Sekunden","in %s Sekunden"],["vor 1 Minute","in 1 Minute"],["vor %s Minuten","in %s Minuten"],["vor 1 Stunde","in 1 Stunde"],["vor %s Stunden","in %s Stunden"],["vor 1 Tag","in 1 Tag"],["vor %s Tagen","in %s Tagen"],["vor 1 Woche","in 1 Woche"],["vor %s Wochen","in %s Wochen"],["vor 1 Monat","in 1 Monat"],["vor %s Monaten","in %s Monaten"],["vor 1 Jahr","in 1 Jahr"],["vor %s Jahren","in %s Jahren"]][n];},el:function el(s,n){return[["μόλις τώρα","σε λίγο"],["%s δευτερόλεπτα πριν","σε %s δευτερόλεπτα"],["1 λεπτό πριν","σε 1 λεπτό"],["%s λεπτά πριν","σε %s λεπτά"],["1 ώρα πριν","σε 1 ώρα"],["%s ώρες πριν","σε %s ώρες"],["1 μέρα πριν","σε 1 μέρα"],["%s μέρες πριν","σε %s μέρες"],["1 εβδομάδα πριν","σε 1 εβδομάδα"],["%s εβδομάδες πριν","σε %s εβδομάδες"],["1 μήνα πριν","σε 1 μήνα"],["%s μήνες πριν","σε %s μήνες"],["1 χρόνο πριν","σε 1 χρόνο"],["%s χρόνια πριν","σε %s χρόνια"]][n];},en_short:function en_short(s,n){return[["just now","right now"],["%ss ago","in %ss"],["1m ago","in 1m"],["%sm ago","in %sm"],["1h ago","in 1h"],["%sh ago","in %sh"],["1d ago","in 1d"],["%sd ago","in %sd"],["1w ago","in 1w"],["%sw ago","in %sw"],["1mo ago","in 1mo"],["%smo ago","in %smo"],["1yr ago","in 1yr"],["%syr ago","in %syr"]][n];},en_US:n,es:function es(s,n){return[["justo ahora","en un rato"],["hace %s segundos","en %s segundos"],["hace 1 minuto","en 1 minuto"],["hace %s minutos","en %s minutos"],["hace 1 hora","en 1 hora"],["hace %s horas","en %s horas"],["hace 1 día","en 1 día"],["hace %s días","en %s días"],["hace 1 semana","en 1 semana"],["hace %s semanas","en %s semanas"],["hace 1 mes","en 1 mes"],["hace %s meses","en %s meses"],["hace 1 año","en 1 año"],["hace %s años","en %s años"]][n];},eu:function eu(s,n){return[["orain","denbora bat barru"],["duela %s segundu","%s segundu barru"],["duela minutu 1","minutu 1 barru"],["duela %s minutu","%s minutu barru"],["duela ordu 1","ordu 1 barru"],["duela %s ordu","%s ordu barru"],["duela egun 1","egun 1 barru"],["duela %s egun","%s egun barru"],["duela aste 1","aste 1 barru"],["duela %s aste","%s aste barru"],["duela hillabete 1","hillabete 1 barru"],["duela %s hillabete","%s hillabete barru"],["duela urte 1","urte 1 barru"],["duela %s urte","%s urte barru"]][n];},fa:function fa(s,n){var e=[["لحظاتی پیش","همین حالا"],["%s ثانیه پیش","%s ثانیه دیگر"],["۱ دقیقه پیش","۱ دقیقه دیگر"],["%s دقیقه پیش","%s دقیقه دیگر"],["۱ ساعت پیش","۱ ساعت دیگر"],["%s ساعت پیش","%s ساعت دیگر"],["۱ روز پیش","۱ روز دیگر"],["%s روز پیش","%s روز دیگر"],["۱ هفته پیش","۱ هفته دیگر"],["%s هفته پیش","%s هفته دیگر"],["۱ ماه پیش","۱ ماه دیگر"],["%s ماه پیش","%s ماه دیگر"],["۱ سال پیش","۱ سال دیگر"],["%s سال پیش","%s سال دیگر"]][n];return[e[0].replace("%s",q(s)),e[1].replace("%s",q(s))];},fi:function fi(s,n){return[["juuri äsken","juuri nyt"],["%s sekuntia sitten","%s sekunnin päästä"],["minuutti sitten","minuutin päästä"],["%s minuuttia sitten","%s minuutin päästä"],["tunti sitten","tunnin päästä"],["%s tuntia sitten","%s tunnin päästä"],["päivä sitten","päivän päästä"],["%s päivää sitten","%s päivän päästä"],["viikko sitten","viikon päästä"],["%s viikkoa sitten","%s viikon päästä"],["kuukausi sitten","kuukauden päästä"],["%s kuukautta sitten","%s kuukauden päästä"],["vuosi sitten","vuoden päästä"],["%s vuotta sitten","%s vuoden päästä"]][n];},fr:function fr(s,n){return[["à l'instant","dans un instant"],["il y a %s secondes","dans %s secondes"],["il y a 1 minute","dans 1 minute"],["il y a %s minutes","dans %s minutes"],["il y a 1 heure","dans 1 heure"],["il y a %s heures","dans %s heures"],["il y a 1 jour","dans 1 jour"],["il y a %s jours","dans %s jours"],["il y a 1 semaine","dans 1 semaine"],["il y a %s semaines","dans %s semaines"],["il y a 1 mois","dans 1 mois"],["il y a %s mois","dans %s mois"],["il y a 1 an","dans 1 an"],["il y a %s ans","dans %s ans"]][n];},gl:function gl(s,n){return[["xusto agora","daquí a un pouco"],["hai %s segundos","en %s segundos"],["hai 1 minuto","nun minuto"],["hai %s minutos","en %s minutos"],["hai 1 hora","nunha hora"],["hai %s horas","en %s horas"],["hai 1 día","nun día"],["hai %s días","en %s días"],["hai 1 semana","nunha semana"],["hai %s semanas","en %s semanas"],["hai 1 mes","nun mes"],["hai %s meses","en %s meses"],["hai 1 ano","nun ano"],["hai %s anos","en %s anos"]][n];},he:function he(s,n){return[["זה עתה","עכשיו"],["לפני %s שניות","בעוד %s שניות"],["לפני דקה","בעוד דקה"],["לפני %s דקות","בעוד %s דקות"],["לפני שעה","בעוד שעה"],2===s?["לפני שעתיים","בעוד שעתיים"]:["לפני %s שעות","בעוד %s שעות"],["אתמול","מחר"],2===s?["לפני יומיים","בעוד יומיים"]:["לפני %s ימים","בעוד %s ימים"],["לפני שבוע","בעוד שבוע"],2===s?["לפני שבועיים","בעוד שבועיים"]:["לפני %s שבועות","בעוד %s שבועות"],["לפני חודש","בעוד חודש"],2===s?["לפני חודשיים","בעוד חודשיים"]:["לפני %s חודשים","בעוד %s חודשים"],["לפני שנה","בעוד שנה"],2===s?["לפני שנתיים","בעוד שנתיים"]:["לפני %s שנים","בעוד %s שנים"]][n];},hi_IN:function hi_IN(s,n){return[["अभी","कुछ समय"],["%s सेकंड पहले","%s सेकंड में"],["1 मिनट पहले","1 मिनट में"],["%s मिनट पहले","%s मिनट में"],["1 घंटे पहले","1 घंटे में"],["%s घंटे पहले","%s घंटे में"],["1 दिन पहले","1 दिन में"],["%s दिन पहले","%s दिनों में"],["1 सप्ताह पहले","1 सप्ताह में"],["%s हफ्ते पहले","%s हफ्तों में"],["1 महीने पहले","1 महीने में"],["%s महीने पहले","%s महीनों में"],["1 साल पहले","1 साल में"],["%s साल पहले","%s साल में"]][n];},hu:function hu(s,n){return[["éppen most","éppen most"],["%s másodperce","%s másodpercen belül"],["1 perce","1 percen belül"],["%s perce","%s percen belül"],["1 órája","1 órán belül"],["%s órája","%s órán belül"],["1 napja","1 napon belül"],["%s napja","%s napon belül"],["1 hete","1 héten belül"],["%s hete","%s héten belül"],["1 hónapja","1 hónapon belül"],["%s hónapja","%s hónapon belül"],["1 éve","1 éven belül"],["%s éve","%s éven belül"]][n];},id_ID:function id_ID(s,n){return[["baru saja","sebentar"],["%s detik yang lalu","dalam %s detik"],["1 menit yang lalu","dalam 1 menit"],["%s menit yang lalu","dalam %s menit"],["1 jam yang lalu","dalam 1 jam"],["%s jam yang lalu","dalam %s jam"],["1 hari yang lalu","dalam 1 hari"],["%s hari yang lalu","dalam %s hari"],["1 minggu yang lalu","dalam 1 minggu"],["%s minggu yang lalu","dalam %s minggu"],["1 bulan yang lalu","dalam 1 bulan"],["%s bulan yang lalu","dalam %s bulan"],["1 tahun yang lalu","dalam 1 tahun"],["%s tahun yang lalu","dalam %s tahun"]][n];},it:function it(s,n){return[["poco fa","fra poco"],["%s secondi fa","fra %s secondi"],["un minuto fa","fra un minuto"],["%s minuti fa","fra %s minuti"],["un'ora fa","fra un'ora"],["%s ore fa","fra %s ore"],["un giorno fa","fra un giorno"],["%s giorni fa","fra %s giorni"],["una settimana fa","fra una settimana"],["%s settimane fa","fra %s settimane"],["un mese fa","fra un mese"],["%s mesi fa","fra %s mesi"],["un anno fa","fra un anno"],["%s anni fa","fra %s anni"]][n];},ja:function ja(s,n){return[["すこし前","すぐに"],["%s秒前","%s秒以内"],["1分前","1分以内"],["%s分前","%s分以内"],["1時間前","1時間以内"],["%s時間前","%s時間以内"],["1日前","1日以内"],["%s日前","%s日以内"],["1週間前","1週間以内"],["%s週間前","%s週間以内"],["1ヶ月前","1ヶ月以内"],["%sヶ月前","%sヶ月以内"],["1年前","1年以内"],["%s年前","%s年以内"]][n];},ko:function ko(s,n){return[["방금","곧"],["%s초 전","%s초 후"],["1분 전","1분 후"],["%s분 전","%s분 후"],["1시간 전","1시간 후"],["%s시간 전","%s시간 후"],["1일 전","1일 후"],["%s일 전","%s일 후"],["1주일 전","1주일 후"],["%s주일 전","%s주일 후"],["1개월 전","1개월 후"],["%s개월 전","%s개월 후"],["1년 전","1년 후"],["%s년 전","%s년 후"]][n];},ml:function ml(s,n){return[["ഇപ്പോള്‍","കുറച്ചു മുന്‍പ്"],["%s സെക്കന്റ്‌കള്‍ക്ക് മുന്‍പ്","%s സെക്കന്റില്‍"],["1 മിനിറ്റിനു മുന്‍പ്","1 മിനിറ്റില്‍"],["%s മിനിറ്റുകള്‍ക്ക് മുന്‍പ","%s മിനിറ്റില്‍"],["1 മണിക്കൂറിനു മുന്‍പ്","1 മണിക്കൂറില്‍"],["%s മണിക്കൂറുകള്‍ക്കു മുന്‍പ്","%s മണിക്കൂറില്‍"],["1 ഒരു ദിവസം മുന്‍പ്","1 ദിവസത്തില്‍"],["%s ദിവസങ്ങള്‍ക് മുന്‍പ്","%s ദിവസങ്ങള്‍ക്കുള്ളില്‍"],["1 ആഴ്ച മുന്‍പ്","1 ആഴ്ചയില്‍"],["%s ആഴ്ചകള്‍ക്ക് മുന്‍പ്","%s ആഴ്ചകള്‍ക്കുള്ളില്‍"],["1 മാസത്തിനു മുന്‍പ്","1 മാസത്തിനുള്ളില്‍"],["%s മാസങ്ങള്‍ക്ക് മുന്‍പ്","%s മാസങ്ങള്‍ക്കുള്ളില്‍"],["1 വര്‍ഷത്തിനു  മുന്‍പ്","1 വര്‍ഷത്തിനുള്ളില്‍"],["%s വര്‍ഷങ്ങള്‍ക്കു മുന്‍പ്","%s വര്‍ഷങ്ങള്‍ക്കുല്ല്ളില്‍"]][n];},my:function my(s,n){return[["ယခုအတွင်း","ယခု"],["%s စက္ကန့် အကြာက","%s စက္ကန့်အတွင်း"],["1 မိနစ် အကြာက","1 မိနစ်အတွင်း"],["%s မိနစ် အကြာက","%s မိနစ်အတွင်း"],["1 နာရီ အကြာက","1 နာရီအတွင်း"],["%s နာရီ အကြာက","%s နာရီအတွင်း"],["1 ရက် အကြာက","1 ရက်အတွင်း"],["%s ရက် အကြာက","%s ရက်အတွင်း"],["1 ပတ် အကြာက","1 ပတ်အတွင်း"],["%s ပတ် အကြာက","%s ပတ်အတွင်း"],["1 လ အကြာက","1 လအတွင်း"],["%s လ အကြာက","%s လအတွင်း"],["1 နှစ် အကြာက","1 နှစ်အတွင်း"],["%s နှစ် အကြာက","%s နှစ်အတွင်း"]][n];},nb_NO:function nb_NO(s,n){return[["akkurat nå","om litt"],["%s sekunder siden","om %s sekunder"],["1 minutt siden","om 1 minutt"],["%s minutter siden","om %s minutter"],["1 time siden","om 1 time"],["%s timer siden","om %s timer"],["1 dag siden","om 1 dag"],["%s dager siden","om %s dager"],["1 uke siden","om 1 uke"],["%s uker siden","om %s uker"],["1 måned siden","om 1 måned"],["%s måneder siden","om %s måneder"],["1 år siden","om 1 år"],["%s år siden","om %s år"]][n];},nl:function nl(s,n){return[["recent","binnenkort"],["%s seconden geleden","binnen %s seconden"],["1 minuut geleden","binnen 1 minuut"],["%s minuten geleden","binnen %s minuten"],["1 uur geleden","binnen 1 uur"],["%s uur geleden","binnen %s uur"],["1 dag geleden","binnen 1 dag"],["%s dagen geleden","binnen %s dagen"],["1 week geleden","binnen 1 week"],["%s weken geleden","binnen %s weken"],["1 maand geleden","binnen 1 maand"],["%s maanden geleden","binnen %s maanden"],["1 jaar geleden","binnen 1 jaar"],["%s jaar geleden","binnen %s jaar"]][n];},nn_NO:function nn_NO(s,n){return[["nett no","om litt"],["%s sekund sidan","om %s sekund"],["1 minutt sidan","om 1 minutt"],["%s minutt sidan","om %s minutt"],["1 time sidan","om 1 time"],["%s timar sidan","om %s timar"],["1 dag sidan","om 1 dag"],["%s dagar sidan","om %s dagar"],["1 veke sidan","om 1 veke"],["%s veker sidan","om %s veker"],["1 månad sidan","om 1 månad"],["%s månadar sidan","om %s månadar"],["1 år sidan","om 1 år"],["%s år sidan","om %s år"]][n];},pl:function pl(s,n){return S[1&n?4<s%10||s%10<2||1==~~(s/10)%10?n:++n/2+13:n];},pt_BR:function pt_BR(s,n){return[["agora mesmo","agora"],["há %s segundos","em %s segundos"],["há um minuto","em um minuto"],["há %s minutos","em %s minutos"],["há uma hora","em uma hora"],["há %s horas","em %s horas"],["há um dia","em um dia"],["há %s dias","em %s dias"],["há uma semana","em uma semana"],["há %s semanas","em %s semanas"],["há um mês","em um mês"],["há %s meses","em %s meses"],["há um ano","em um ano"],["há %s anos","em %s anos"]][n];},ro:function ro(s,n){var e=[["chiar acum","chiar acum"],["acum %s secunde","peste %s secunde"],["acum un minut","peste un minut"],["acum %s minute","peste %s minute"],["acum o oră","peste o oră"],["acum %s ore","peste %s ore"],["acum o zi","peste o zi"],["acum %s zile","peste %s zile"],["acum o săptămână","peste o săptămână"],["acum %s săptămâni","peste %s săptămâni"],["acum o lună","peste o lună"],["acum %s luni","peste %s luni"],["acum un an","peste un an"],["acum %s ani","peste %s ani"]];return s<20?e[n]:[e[n][0].replace("%s","%s de"),e[n][1].replace("%s","%s de")];},ru:function ru(s,n){switch(n){case 0:return["только что","через несколько секунд"];case 1:return[N(s)+" назад","через "+N(s)];case 2:case 3:return[x(s)+" назад","через "+x(s)];case 4:case 5:return[D(s)+" назад","через "+D(s)];case 6:return["вчера","завтра"];case 7:return[I(s)+" назад","через "+I(s)];case 8:case 9:return[O(s)+" назад","через "+O(s)];case 10:case 11:return[W(s)+" назад","через "+W(s)];case 12:case 13:return[$(s)+" назад","через "+$(s)];default:return["",""];}},sq:function sq(s,n){return[["pak më parë","pas pak"],["para %s sekondash","pas %s sekondash"],["para një minute","pas një minute"],["para %s minutash","pas %s minutash"],["para një ore","pas një ore"],["para %s orësh","pas %s orësh"],["dje","nesër"],["para %s ditësh","pas %s ditësh"],["para një jave","pas një jave"],["para %s javësh","pas %s javësh"],["para një muaji","pas një muaji"],["para %s muajsh","pas %s muajsh"],["para një viti","pas një viti"],["para %s vjetësh","pas %s vjetësh"]][n];},sr:function sr(s,n){switch(n){case 0:return["малопре","управо сад"];case 1:return["пре "+U(s),"за "+U(s)];case 2:case 3:return["пре "+A(s),"за "+A(s)];case 4:case 5:return["пре "+C(s),"за "+C(s)];case 6:case 7:return["пре "+E(s),"за "+E(s)];case 8:case 9:return["пре "+B(s),"за "+B(s)];case 10:case 11:return["пре "+P(s),"за "+P(s)];case 12:case 13:return["пре "+R(s),"за "+R(s)];default:return["",""];}},sv:function sv(s,n){return[["just nu","om en stund"],["%s sekunder sedan","om %s sekunder"],["1 minut sedan","om 1 minut"],["%s minuter sedan","om %s minuter"],["1 timme sedan","om 1 timme"],["%s timmar sedan","om %s timmar"],["1 dag sedan","om 1 dag"],["%s dagar sedan","om %s dagar"],["1 vecka sedan","om 1 vecka"],["%s veckor sedan","om %s veckor"],["1 månad sedan","om 1 månad"],["%s månader sedan","om %s månader"],["1 år sedan","om 1 år"],["%s år sedan","om %s år"]][n];},ta:function ta(s,n){return[["இப்போது","சற்று நேரம் முன்பு"],["%s நொடிக்கு முன்","%s நொடிகளில்"],["1 நிமிடத்திற்க்கு முன்","1 நிமிடத்தில்"],["%s நிமிடத்திற்க்கு முன்","%s நிமிடங்களில்"],["1 மணி நேரத்திற்கு முன்","1 மணி நேரத்திற்குள்"],["%s மணி நேரத்திற்கு முன்","%s மணி நேரத்திற்குள்"],["1 நாளுக்கு முன்","1 நாளில்"],["%s நாட்களுக்கு முன்","%s நாட்களில்"],["1 வாரத்திற்கு முன்","1 வாரத்தில்"],["%s வாரங்களுக்கு முன்","%s வாரங்களில்"],["1 மாதத்திற்கு முன்","1 மாதத்தில்"],["%s மாதங்களுக்கு முன்","%s மாதங்களில்"],["1 வருடத்திற்கு முன்","1 வருடத்தில்"],["%s வருடங்களுக்கு முன்","%s வருடங்களில்"]][n];},th:function th(s,n){return[["เมื่อสักครู่นี้","อีกสักครู่"],["%s วินาทีที่แล้ว","ใน %s วินาที"],["1 นาทีที่แล้ว","ใน 1 นาที"],["%s นาทีที่แล้ว","ใน %s นาที"],["1 ชั่วโมงที่แล้ว","ใน 1 ชั่วโมง"],["%s ชั่วโมงที่แล้ว","ใน %s ชั่วโมง"],["1 วันที่แล้ว","ใน 1 วัน"],["%s วันที่แล้ว","ใน %s วัน"],["1 อาทิตย์ที่แล้ว","ใน 1 อาทิตย์"],["%s อาทิตย์ที่แล้ว","ใน %s อาทิตย์"],["1 เดือนที่แล้ว","ใน 1 เดือน"],["%s เดือนที่แล้ว","ใน %s เดือน"],["1 ปีที่แล้ว","ใน 1 ปี"],["%s ปีที่แล้ว","ใน %s ปี"]][n];},tr:function tr(s,n){return[["az önce","şimdi"],["%s saniye önce","%s saniye içinde"],["1 dakika önce","1 dakika içinde"],["%s dakika önce","%s dakika içinde"],["1 saat önce","1 saat içinde"],["%s saat önce","%s saat içinde"],["1 gün önce","1 gün içinde"],["%s gün önce","%s gün içinde"],["1 hafta önce","1 hafta içinde"],["%s hafta önce","%s hafta içinde"],["1 ay önce","1 ay içinde"],["%s ay önce","%s ay içinde"],["1 yıl önce","1 yıl içinde"],["%s yıl önce","%s yıl içinde"]][n];},uk:function uk(s,n){switch(n){case 0:return["щойно","через декілька секунд"];case 1:return[F(s)+" тому","через "+F(s)];case 2:case 3:return[G(s)+" тому","через "+G(s)];case 4:case 5:return[H(s)+" тому","через "+H(s)];case 6:case 7:return[K(s)+" тому","через "+K(s)];case 8:case 9:return[L(s)+" тому","через "+L(s)];case 10:case 11:return[Q(s)+" тому","через "+Q(s)];case 12:case 13:return[V(s)+" тому","через "+V(s)];default:return["",""];}},vi:function vi(s,n){return[["vừa xong","một lúc"],["%s giây trước","trong %s giây"],["1 phút trước","trong 1 phút"],["%s phút trước","trong %s phút"],["1 giờ trước","trong 1 giờ"],["%s giờ trước","trong %s giờ"],["1 ngày trước","trong 1 ngày"],["%s ngày trước","trong %s ngày"],["1 tuần trước","trong 1 tuần"],["%s tuần trước","trong %s tuần"],["1 tháng trước","trong 1 tháng"],["%s tháng trước","trong %s tháng"],["1 năm trước","trong 1 năm"],["%s năm trước","trong %s năm"]][n];},zh_CN:e,zh_TW:function zh_TW(s,n){return[["剛剛","片刻後"],["%s 秒前","%s 秒後"],["1 分鐘前","1 分鐘後"],["%s 分鐘前","%s 分鐘後"],["1 小時前","1 小時後"],["%s 小時前","%s 小時後"],["1 天前","1 天後"],["%s 天前","%s 天後"],["1 週前","1 週後"],["%s 週前","%s 週後"],["1 個月前","1 個月後"],["%s 個月前","%s 個月後"],["1 年前","1 年後"],["%s 年前","%s 年後"]][n];}});Object.keys(X).forEach(function(s){u(s,X[s]);}),s.cancel=function(s){s?f(h(s)):Object.keys(g).forEach(f);},s.format=function(s,n,e){return d(c(s,e&&e.relativeDate),r(n));},s.register=u,s.render=function(s,n,e){var a=s.length?s:[s];return a.forEach(function(s){p(s,s.getAttribute("datetime"),r(n),e||{});}),a;},Object.defineProperty(s,"__esModule",{value:!0});});Vue.component('add-plant-type',{props:['garden_id'],data:function data(){return{modal:false,searchBox:false,searchQuery:"",searchInterval:300,searchTimer:false,searchLoading:false,searchResults:[],error:false};},methods:{showModal:function showModal(){this.modal.modal('show');if(window.innerWidth<=770){this.searchBox.blur();}},onDeny:function onDeny(){return;},onApprove:function onApprove(){(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee3(){return _regenerator["default"].wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:case"end":return _context3.stop();}}},_callee3);}))();return false;},searchPlantTypes:function searchPlantTypes(){var _this2=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(){var req,res;return _regenerator["default"].wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:if(window.innerWidth<=770){_this2.searchBox.blur();}if(!_this2.searchQuery){_context4.next=13;break;}_this2.searchLoading=true;_context4.next=5;return fetch("/api/search-type/"+_this2.searchQuery);case 5:req=_context4.sent;_context4.next=8;return req.json();case 8:res=_context4.sent;_this2.searchResults=res;_this2.searchLoading=false;_context4.next=14;break;case 13:_this2.searchResults=[];case 14:case"end":return _context4.stop();}}},_callee4);}))();}},mounted:function(){var _mounted=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(){var _this3=this;return _regenerator["default"].wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:this.searchBox=$(this.$el).find('.search input');this.searchBox.on("keyup",function(){clearTimeout(_this3.searchTimer);_this3.searchTimer=setTimeout(_this3.searchPlantTypes,_this3.searchInterval);});this.searchBox.on("keydown",function(){clearTimeout(_this3.searchTimer);});this.modal=$(this.$el).find(".modal").modal({closable:true,transition:"horizontal flip",onDeny:this.onDeny,onApprove:this.onApprove});case 4:case"end":return _context5.stop();}}},_callee5,this);}));function mounted(){return _mounted.apply(this,arguments);}return mounted;}(),template:"\n        <div class=\"add-plant-container\">\n            <div class=\"ui modal small\">\n                <div class=\"header\">\n                    Add Plants\n                </div>\n                <div class=\"content add-plant-searchbox\">\n                    <div class=\"ui search\" v-bind:class=\"{loading: searchLoading}\">\n                        <div class=\"ui left icon input\">\n                            <input v-model=\"searchQuery\" class=\"prompt\" type=\"text\" placeholder=\"Search Plant Index\">\n                            <i class=\"seedling icon green\"></i>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"content scrolling\">\n                    <template v-if=\"searchResults.length\">\n                        <div class=\"search-results ui items\">\n                            <template v-for=\"type in searchResults\">\n                                <plant-type-result v-bind:garden_id=\"garden_id\" v-bind:plant_type=\"type\"></plant-type-result>\n                            </template>\n                        </div>\n                    </template>\n                </div>\n                <div class=\"actions\">\n                    <div class=\"ui negative button\">\n                        Close\n                    </div>\n                </div>\n            </div>\n            <button @click.prevent=\"showModal\" class=\"ui right labeled icon button positive\">\n                Add Plants <i class=\"plus right icon\"></i>\n            </button>\n        </div>\n        "});Vue.component('all-gardens',{data:function data(){return{loading:false,gardens:false};},methods:{getAllGardens:function getAllGardens(){var _this4=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee6(){var req,res;return _regenerator["default"].wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:_this4.loading=true;_context6.next=3;return fetch("/api/get-all-gardens");case 3:req=_context6.sent;_context6.next=6;return req.json();case 6:res=_context6.sent;_this4.gardens=res;_this4.loading=false;case 9:case"end":return _context6.stop();}}},_callee6);}))();},reload:function reload(){var _this5=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee7(){return _regenerator["default"].wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:_context7.next=2;return _this5.getAllGardens();case 2:case"end":return _context7.stop();}}},_callee7);}))();}},mounted:function(){var _mounted2=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee8(){return _regenerator["default"].wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:_context8.next=2;return this.reload();case 2:case"end":return _context8.stop();}}},_callee8,this);}));function mounted(){return _mounted2.apply(this,arguments);}return mounted;}(),template:"\n        <div v-if=\"loading\" class=\"loading-text\">\n            <div class=\"ui active large centered inline loader text green\">Loading Gardens...</div>\n        </div>\n        <template v-else-if=\"!loading\">\n            <div v-if=\"gardens && gardens.length\" class=\"gardens-list ui link cards\">\n                <template v-for=\"garden in gardens\">\n                    <garden-item v-bind:garden=\"garden\"></garden-item>\n                </template>\n            </div>\n            <div class=\"gardens-empty\" v-else-if=\"gardens && !gardens.length\">\n            There are no gardens\n            </div>\n        </template>\n\n    "});Vue.component('create-garden',{props:['user_id'],data:function data(){return{modal:false,loading:false,error:false,name:"",description:""};},methods:{showModal:function showModal(){this.modal.modal('show');},onDeny:function onDeny(){return;},onApprove:function onApprove(){var _this6=this;(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee9(){var res;return _regenerator["default"].wrap(function _callee9$(_context9){while(1){switch(_context9.prev=_context9.next){case 0:_this6.error=false;_this6.loading=true;_context9.next=4;return formEncodedPOST("/api/create-garden",{name:_this6.name,description:_this6.description});case 4:res=_context9.sent;_this6.loading=false;if(res.error){_this6.error=res.error;}else if(res.success){_this6.modal.modal('hide');if(app.$refs.user_gardens){app.$refs.user_gardens.reload();$(_this6.$el).find(".modal form")[0].reset();}}case 7:case"end":return _context9.stop();}}},_callee9);}))();return false;}},mounted:function(){var _mounted3=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee10(){return _regenerator["default"].wrap(function _callee10$(_context10){while(1){switch(_context10.prev=_context10.next){case 0:this.modal=$(this.$el).find(".modal").modal({closable:true,transition:"horizontal flip",onDeny:this.onDeny,onApprove:this.onApprove});case 1:case"end":return _context10.stop();}}},_callee10,this);}));function mounted(){return _mounted3.apply(this,arguments);}return mounted;}(),template:"\n        <div class=\"create-garden-container\">\n            <div class=\"ui modal tiny create-garden-modal\">\n                <div class=\"header\">\n                    Create Garden\n                </div>\n                <div class=\"content\">\n                    <form class=\"ui form\" @submit.prevent=\"onApprove\">\n                        <transition name=\"fade\">\n                            <div class=\"form-error\" v-if=\"error\">{{ error }}</div>\n                        </transition>\n                        <div class=\"field\">\n                            <label>Garden Name</label>\n                            <input type=\"text\" v-model=\"name\" name=\"name\" placeholder=\"Name\">\n                        </div>\n                        <div class=\"field\">\n                            <label>Garden Description</label>\n                            <textarea v-model=\"description\" rows=\"2\" name=\"description\" placeholder=\"Description\"></textarea>\n                        </div>\n                    </form>\n                </div>\n                <div class=\"actions\">\n                    <template v-if=\"loading\">\n                        <div class=\"ui negative disabled inactive button\">\n                            Cancel\n                        </div>\n                        <div class=\"ui positive disabled inactive button\">\n                            Loading... <div class=\"ui active right inline mini loader\"></div>\n                        </div>\n                    </template>\n                    <template v-else-if=\"!loading\">\n                        <div class=\"ui negative button\">\n                            Cancel\n                        </div>\n                        <div class=\"ui positive right labeled icon button\">\n                            Create\n                            <i class=\"plus right icon\"></i>\n                        </div>\n                    </template>\n                </div>\n            </div>\n            <button @click.prevent=\"showModal\" class=\"ui right labeled icon button positive\">\n                Create Garden <i class=\"right plus icon\"></i>\n            </button>\n        </div>\n        "});Vue.component('delete-plant-button',{props:["plant_id"],data:function data(){return{loading:false};},methods:{deletePlant:function deletePlant(){var _this7=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee11(){var res;return _regenerator["default"].wrap(function _callee11$(_context11){while(1){switch(_context11.prev=_context11.next){case 0:_this7.loading=true;_context11.next=3;return formEncodedPOST("/api/delete-garden-plant",{plant_id:_this7.plant_id});case 3:res=_context11.sent;_this7.loading=false;if(res.success){_this7.hide(res.success);}else{$('body').toast({"class":'error',message:"".concat(res.error),displayTime:1000,position:window.innerWidth<=770?"top center":"top right"});}case 6:case"end":return _context11.stop();}}},_callee11);}))();},hide:function hide(deleted_plant){this.$parent.$parent.remove(deleted_plant._id);}},computed:{deleteButtonText:function deleteButtonText(){return this.loading?"Deleting...":"Delete";}},template:"\n        <button class=\"ui right labeled icon button basic\" v-bind:class=\"{loading: loading, red: loading}\" @click.prevent=\"deletePlant\">\n            {{deleteButtonText}}\n            <i class=\"right trash icon red\"></i>\n        </button>\n        "});Vue.component('edit-plant-button',{props:["plant_id"],methods:{editPlant:function editPlant(){var _this8=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee12(){return _regenerator["default"].wrap(function _callee12$(_context12){while(1){switch(_context12.prev=_context12.next){case 0:_this8.$parent.$refs.plant_modal.showModal();case 1:case"end":return _context12.stop();}}},_callee12);}))();}},template:"\n        <button class=\"ui labeled icon button basic\" @click.prevent=\"editPlant\">\n            <i class=\"edit icon blue\"></i>\n            Edit\n        </button>\n        "});Vue.component('edit-plant-modal',{props:['plant'],data:function data(){return{modal:false,fileUploading:false,showing:false};},methods:{showModal:function showModal(){this.modal.modal('show');},onDeny:function onDeny(){return;},onApprove:function onApprove(){(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee13(){return _regenerator["default"].wrap(function _callee13$(_context13){while(1){switch(_context13.prev=_context13.next){case 0:case"end":return _context13.stop();}}},_callee13);}))();return false;},uploadPlantPhoto:function uploadPlantPhoto(){var _this9=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee14(){var form,formData,req,res;return _regenerator["default"].wrap(function _callee14$(_context14){while(1){switch(_context14.prev=_context14.next){case 0:_this9.fileUploading=true;form=_this9.$el.querySelector(".upload-photo-form");formData=new FormData(form);formData.append("plant_id",_this9.plant._id);_context14.next=6;return fetch('/api/plant-photo-upload',{method:'POST',body:formData});case 6:req=_context14.sent;_context14.next=9;return req.json();case 9:res=_context14.sent;_this9.fileUploading=false;if(res.success){_this9.setPhoto(res.src);}else{$('body').toast({"class":'error',message:"".concat(res.error),displayTime:1000,position:window.innerWidth<=770?"top center":"top right"});}case 12:case"end":return _context14.stop();}}},_callee14);}))();},setPhoto:function setPhoto(src){this.plant.image=src;},setPlant:function setPlant(plant){this.plant=plant;},changePhoto:function changePhoto(){var _this10=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee15(){return _regenerator["default"].wrap(function _callee15$(_context15){while(1){switch(_context15.prev=_context15.next){case 0:if(!_this10.fileUploading){$(_this10.$el).find('input[type="file"]').click();}case 1:case"end":return _context15.stop();}}},_callee15);}))();}},mounted:function mounted(){var _this11=this;$(this.$el).find('.special.cards .image').dimmer({on:'hover'});this.modal=$(this.$el).modal({closable:true,transition:"zoom",autofocus:false,onDeny:this.onDeny,onApprove:this.onApprove,onShow:function onShow(){_this11.showing=true;},onHidden:function onHidden(){_this11.showing=false;},onHide:function onHide(){_this11.$parent.$parent.reload();}});},template:"\n    <div class=\"ui modal small\">\n        <div class=\"header\">\n            Edit Plant - {{plant.type_id.name}}\n        </div>\n        <div class=\"content\">\n            <div class=\"ui special cards align center\">\n                <div class=\"card centered edit-plant-block\">\n                    <div class=\"blurring dimmable image\">\n                        <div class=\"ui dimmer\">\n                        <div class=\"content\">\n                            <div class=\"center\">\n                                <form class=\"ui hidden upload-photo-form\">\n                                    <div class=\"ui inverted button\" @touchend.prevent=\"changePhoto\" @click.prevent=\"changePhoto\">\n                                        <template v-if=\"fileUploading\">\n                                            Uploading...\n                                        </template>\n                                        <template v-else-if=\"!fileUploading\">\n                                            <i class=\"upload icon\"></i>\n                                            Upload Photo\n                                        </template>\n                                    </div>\n                                    <input class=\"plant-photo-upload\" @change.prevent=\"uploadPlantPhoto\" type=\"file\" name=\"photo\" />\n                                </form>\n                            </div>\n                        </div>\n                        </div>\n                        <img v-bind:src=\"plant.image\" v-bind:alt=\"plant.type_id.name\"/>\n                    </div>\n                    <div class=\"content\">\n                        <a class=\"header\">{{plant.type_id.name}}</a>\n                        <div class=\"meta\">\n                            <span class=\"date\">\n                                {{plant._id}}\n                            </span>\n                        </div>\n                    </div>\n                    <div class=\"extra content\">\n                        <edit-plant-species-select v-bind:modal_showing=\"showing\" v-bind:plant=\"plant\"></edit-plant-species-select>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"actions\">\n            <div class=\"ui negative button\">\n                Close\n            </div>\n        </div>\n    </div>\n    "});Vue.component('edit-plant-species-select',{props:['plant','modal_showing'],data:function data(){return{loading:false,retrieved:false,error:false};},methods:{// getPlantValue() {
//     return $(this.$el).find('.ui.dropdown')
//     .dropdown('get value');
// },
getRelatedSpecies:function getRelatedSpecies(){var _this12=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee16(){var req,res;return _regenerator["default"].wrap(function _callee16$(_context16){while(1){switch(_context16.prev=_context16.next){case 0:_this12.loading=true;_context16.next=3;return fetch("/api/get-related-species/"+_this12.plant._id);case 3:req=_context16.sent;_context16.next=6;return req.json();case 6:res=_context16.sent;_this12.loading=false;if(!res.success){_context16.next=12;break;}return _context16.abrupt("return",res.success);case 12:return _context16.abrupt("return",[]);case 13:case"end":return _context16.stop();}}},_callee16);}))();},updateSpeciesType:function updateSpeciesType(species_id){var _this13=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee17(){var res;return _regenerator["default"].wrap(function _callee17$(_context17){while(1){switch(_context17.prev=_context17.next){case 0:_this13.error=false;_this13.loading=true;_context17.next=4;return formEncodedPOST("/api/select-plant-species",{plant_id:_this13.plant._id,species_id:species_id});case 4:res=_context17.sent;_this13.loading=false;if(res.error){_this13.error=res.error;}else if(res.success){_this13.$parent.setPlant(res.success);// this.plant = res.success;
// this.$parent.$parent.$parent.reload();
// this.$parent.plant = res.success;
}case 7:case"end":return _context17.stop();}}},_callee17);}))();},onChange:function onChange(species_id,text){var _this14=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee18(){return _regenerator["default"].wrap(function _callee18$(_context18){while(1){switch(_context18.prev=_context18.next){case 0:if(!(species_id&&species_id!==""&&text!==_this14.scientific_name)){_context18.next=3;break;}_context18.next=3;return _this14.updateSpeciesType(species_id);case 3:case"end":return _context18.stop();}}},_callee18);}))();}},computed:{scientific_name:function scientific_name(){return this.plant.plant_id&&this.plant.plant_id.scientific_name?this.plant.plant_id.scientific_name:this.plant.type_id.botanical_name;}},watch:{modal_showing:function(){var _modal_showing=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee19(showing,oldVal){var _this15=this;var values,_values$filter,_values$filter2,selected;return _regenerator["default"].wrap(function _callee19$(_context19){while(1){switch(_context19.prev=_context19.next){case 0:if(!(showing&&!this.retrieved)){_context19.next=8;break;}_context19.next=3;return this.getRelatedSpecies();case 3:values=_context19.sent;$(this.$el).dropdown('change values',values);this.retrieved=true;_values$filter=values.filter(function(species){return species.name.toLowerCase()===_this15.scientific_name.toLowerCase();}),_values$filter2=(0,_slicedToArray2["default"])(_values$filter,1),selected=_values$filter2[0];if(selected){$(this.$el).dropdown("set selected",selected.value);}case 8:case"end":return _context19.stop();}}},_callee19,this);}));function modal_showing(_x3,_x4){return _modal_showing.apply(this,arguments);}return modal_showing;}()},mounted:function(){var _mounted4=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee20(){return _regenerator["default"].wrap(function _callee20$(_context20){while(1){switch(_context20.prev=_context20.next){case 0:$(this.$el).dropdown({direction:'upward',placeholder:"Select Species",forceSelection:false,onChange:this.onChange});case 1:case"end":return _context20.stop();}}},_callee20,this);}));function mounted(){return _mounted4.apply(this,arguments);}return mounted;}(),template:"\n    <div class=\"ui dropdown search fluid selection\" v-bind:class=\"{loading: loading, disabled: loading}\">\n        <i class=\"dropdown icon\"></i>\n        <span class=\"text\">Select Species</span>\n        <div class=\"menu\"></div>\n    </div>\n    "});Vue.component('garden-item',{props:['garden'],methods:{},computed:{href:function href(){return"/garden/"+this.garden._id;},userOwns:function userOwns(){return app.session._id===this.garden.user_id;},plantsText:function plantsText(){return this.garden.plants.length===1?"Plant":"Plants";}},template:"\n            <a class=\"ui card green\" v-bind:href=\"href\">\n                <div class=\"content\">\n                    <div class=\"header\">{{garden.name}}</div>\n                    <div class=\"description\">\n                        {{garden.description}}\n                    </div>\n                    </div>\n                    <div class=\"extra content\">\n                        <span class=\"right floated\">\n                            By {{garden.user_id.username}}\n                        </span>\n                        <span>\n                            <i class=\"seedling icon\"></i>\n                            {{garden.plants.length}} {{plantsText}}\n                        </span>\n                    </div>\n                </div>\n            </a>\n        "});Vue.component('garden-plants',{props:['garden_id'],data:function data(){return{loading:false,plants:false};},methods:{getGardenPlants:function getGardenPlants(garden_id){var _this16=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee21(){var req,res;return _regenerator["default"].wrap(function _callee21$(_context21){while(1){switch(_context21.prev=_context21.next){case 0:_this16.loading=true;_context21.next=3;return fetch("/api/get-garden-plants/"+garden_id);case 3:req=_context21.sent;_context21.next=6;return req.json();case 6:res=_context21.sent;_this16.loading=false;if(res.success){_this16.plants=res.success;}else{$('body').toast({"class":'error',message:"".concat(res.error),displayTime:1000,position:window.innerWidth<=770?"top center":"top right"});}case 9:case"end":return _context21.stop();}}},_callee21);}))();},remove:function remove(plant_id){this.plants=this.plants.filter(function(plant){return plant._id!==plant_id;});},reload:function reload(){var _this17=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee22(){return _regenerator["default"].wrap(function _callee22$(_context22){while(1){switch(_context22.prev=_context22.next){case 0:if(!_this17.garden_id){_context22.next=3;break;}_context22.next=3;return _this17.getGardenPlants(_this17.garden_id);case 3:case"end":return _context22.stop();}}},_callee22);}))();}},mounted:function(){var _mounted5=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee23(){return _regenerator["default"].wrap(function _callee23$(_context23){while(1){switch(_context23.prev=_context23.next){case 0:_context23.next=2;return this.reload();case 2:case"end":return _context23.stop();}}},_callee23,this);}));function mounted(){return _mounted5.apply(this,arguments);}return mounted;}(),template:"\n            <div v-if=\"loading\" class=\"loading-text\">\n                <div class=\"ui active large centered inline loader text green\">Loading Plants...</div>\n            </div>\n            <template v-else-if=\"!loading\">\n                <div v-if=\"plants && plants.length\" class=\"plants-list ui link cards\">\n                    <template v-for=\"plant in plants\">\n                        <plant-item v-bind:plant=\"plant\"></plant-item>\n                    </template>\n                </div>\n                <div class=\"plants-empty\" v-else-if=\"plants && !plants.length\">\n                You have no plants\n                </div>\n            </template>\n\n        "});Vue.component('login-form',{data:function data(){return{loading:false,error:false,username:"",password:""};},computed:{buttonText:function buttonText(){return this.loading?"Loading...":"Login";}},methods:{onSubmit:function(){var _onSubmit=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee24(e){var res;return _regenerator["default"].wrap(function _callee24$(_context24){while(1){switch(_context24.prev=_context24.next){case 0:this.error=false;this.loading=true;_context24.next=4;return formEncodedPOST("/api/login",{username:this.username,password:this.password,referrer:document.referrer});case 4:res=_context24.sent;if(res.error){this.loading=false;this.error=res.error;}else if(res.success){app.session=res.success;}if(res.redirect){document.location=res.redirect;}case 7:case"end":return _context24.stop();}}},_callee24,this);}));function onSubmit(_x5){return _onSubmit.apply(this,arguments);}return onSubmit;}()},template:"\n        <div class=\"column login-form\">\n            <h2 class=\"ui green image header\">\n                <img src=\"assets/images/logo.png\" class=\"image\">\n                <div class=\"content\">\n                    Log-in to your account\n                </div>\n            </h2>\n            <form @submit.prevent=\"onSubmit\" class=\"ui large form\">\n                <div class=\"ui segment\">\n                    <transition name=\"fade\">\n                        <div class=\"form-error\" v-if=\"error\">{{ error }}</div>\n                    </transition>\n                    <div class=\"field\">\n                        <div class=\"ui left icon input\">\n                            <i class=\"user icon\"></i>\n                            <input\n                            name=\"username\"\n                            v-model=\"username\"\n                            type=\"text\"\n                            placeholder=\"Username\">\n                        </div>\n                    </div>\n                    <div class=\"field\">\n                        <div class=\"ui left icon input\">\n                            <i class=\"lock icon\"></i>\n                            <input\n                            name=\"password\"\n                            v-model=\"password\"\n                            type=\"password\"\n                            placeholder=\"Password\">\n                        </div>\n                    </div>\n                    <button class=\"ui fluid large green submit button\" v-bind:class=\"{disabled: loading}\">{{ buttonText }}</button>\n                </div>\n            </form>\n\n            <div class=\"ui message\">\n                New to us? <a href=\"/register\">Sign Up</a>\n            </div>\n        </div>\n    "});Vue.component('plant-item',{props:['plant'],data:function data(){return{colorClass:"green",deleteLoading:false,waterLoading:false};},methods:{onClick:function onClick(e){console.log("test");},waterDateChange:function waterDateChange(){var _this18=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee25(){var date,res;return _regenerator["default"].wrap(function _callee25$(_context25){while(1){switch(_context25.prev=_context25.next){case 0:date=$(_this18.$el).find(".datepicker").calendar("get date");if(!date){_context25.next=8;break;}_this18.waterLoading=true;_context25.next=5;return formEncodedPOST("/api/set-has-watered",{plant_id:_this18.plant._id});case 5:res=_context25.sent;_this18.waterLoading=false;if(res.success){_this18.plant.watering=res.success;}else{$('body').toast({"class":'error',message:"".concat(res.error),displayTime:1000,position:window.innerWidth<=770?"top center":"top right"});}case 8:case"end":return _context25.stop();}}},_callee25);}))();},waterPlant:function waterPlant(){var _this19=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee26(){return _regenerator["default"].wrap(function _callee26$(_context26){while(1){switch(_context26.prev=_context26.next){case 0:$(_this19.$el).find('.datepicker').calendar('focus');case 1:case"end":return _context26.stop();}}},_callee26);}))();}},computed:{userOwns:function userOwns(){return app.session._id===this.plant.user_id;},scientific_name:function scientific_name(){return this.plant.plant_id&&this.plant.plant_id.scientific_name?this.plant.plant_id.scientific_name:this.plant.type_id.botanical_name;}},mounted:function mounted(){var _this$plant$type_id$f=this.plant.type_id.flower_color.split(",").map(function(c){return c.trim().toLowerCase();}),_this$plant$type_id$f2=(0,_slicedToArray2["default"])(_this$plant$type_id$f,1),color=_this$plant$type_id$f2[0];if(!color||color==="varies"){this.colorClass="green";}else{this.colorClass=color;}$(this.$el).find('.datepicker').calendar({type:'time',maxDate:new Date(),onHide:this.waterDateChange});},template:"\n            <a v-bind:click=\"onClick\" v-bind:class=\"[colorClass]\" class=\"plant-item ui card horizontal centered\" href=\"#\">\n                <div class=\"image\">\n                    <img v-bind:src=\"plant.image\">\n                </div>\n                <div class=\"content\">\n                    <div class=\"header\">\n                        {{plant.type_id.name}}\n                        <template v-if=\"!plant.watering.has_watered\">\n                            <i class=\"tint icon blue\"></i>\n                        </template>\n                    </div>\n                    <div class=\"description\">\n                        {{scientific_name}}\n                    </div>\n                </div>\n\n                <template v-if=\"userOwns\">\n                    <div class=\"extra content\">\n                        <div class=\"ui two buttons\">\n                            <edit-plant-modal v-bind:plant=\"plant\" ref=\"plant_modal\"></edit-plant-modal>\n                            <edit-plant-button v-bind:plant_id=\"plant._id\"></edit-plant-button>\n                            <delete-plant-button v-bind:plant_id=\"plant._id\"></delete-plant-button>\n                        </div>\n                    </div>\n                </template>\n                <template v-if=\"userOwns && !plant.watering.has_watered\">\n                    <div class=\"ui bottom attached button blue\" v-bind:class=\"{loading: waterLoading, disabled: waterLoading}\" @click.prevent=\"waterPlant\">\n                        <i class=\"tint icon\"></i>\n                        Mark as watered\n                        <div class=\"ui calendar datepicker\">\n                            <input type=\"text\" placeholder=\"Date\">\n                        </div>\n                    </div>\n                </template>\n            </a>\n            \n        "});Vue.component('plant-type-result',{props:['garden_id','plant_type'],data:function data(){return{loading:false};},methods:{onClick:function onClick(){var _this20=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee27(){var res;return _regenerator["default"].wrap(function _callee27$(_context27){while(1){switch(_context27.prev=_context27.next){case 0:if(_this20.loading){_context27.next=7;break;}_this20.loading=true;_context27.next=4;return formEncodedPOST("/api/add-to-garden",{garden_id:_this20.garden_id,slug:_this20.plant_type.slug});case 4:res=_context27.sent;_this20.loading=false;if(res.success){$('body').toast({"class":'success',message:"".concat(_this20.plant_type.title," has been added to your garden."),displayTime:1000,position:window.innerWidth<=770?"top center":"top right"});_this20.$parent.$parent.$parent.$refs.garden_plants.reload();}else{$('body').toast({"class":'error',message:"".concat(res.error),displayTime:1000,position:window.innerWidth<=770?"top center":"top right"});}case 7:case"end":return _context27.stop();}}},_callee27);}))();}},computed:{addButtonText:function addButtonText(){return this.loading?"Add":"Add <i class=\"plus right icon\"></i>";}},template:"\n        <div class=\"ui item\">\n            <div class=\"ui middle aligned tiny image\">\n                <img v-bind:src=\"plant_type.thumbnail\">\n            </div>\n            <div class=\"middle aligned content\">\n                {{plant_type.title}}\n            </div>\n            <div class=\"extra middle aligned\" @click.prevent=\"onClick\">\n                <div class=\"ui right green icon button\" v-bind:class=\"{floated: !loading, loading: loading, disabled: loading}\" v-html=\"addButtonText\"></div>\n            </div>\n        </div>\n        "});Vue.component('register-form',{data:function data(){return{loading:false,error:false,email:"",username:"",password:"",passwordRepeat:""};},computed:{buttonText:function buttonText(){return this.loading?"Loading...":"Register";}},methods:{onSubmit:function(){var _onSubmit2=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee28(e){var res;return _regenerator["default"].wrap(function _callee28$(_context28){while(1){switch(_context28.prev=_context28.next){case 0:this.error=false;this.loading=true;_context28.next=4;return formEncodedPOST("/api/register",{email:this.email,username:this.username,password:this.password,passwordRepeat:this.passwordRepeat,referrer:document.referrer});case 4:res=_context28.sent;if(res.error){this.loading=false;this.error=res.error;}else if(res.success){app.session=res.success;}if(res.redirect){document.location=res.redirect;}case 7:case"end":return _context28.stop();}}},_callee28,this);}));function onSubmit(_x6){return _onSubmit2.apply(this,arguments);}return onSubmit;}()},template:"\n        <div class=\"column register-form\">\n            <h2 class=\"ui green image header\">\n                <img src=\"assets/images/logo.png\" class=\"image\" />\n                <div class=\"content\">\n                    Register an account\n                </div>\n            </h2>\n            <form @submit.prevent=\"onSubmit\" class=\"ui large form\">\n                <div class=\"ui segment\">\n                    <transition name=\"fade\">\n                        <div class=\"form-error\" v-if=\"error\">{{ error }}</div>\n                    </transition>\n                    <div class=\"field\">\n                        <div class=\"ui left icon input\">\n                            <i class=\"user icon\"></i>\n                            <input\n                            name=\"email\"\n                            v-model=\"email\"\n                            type=\"text\"\n                            placeholder=\"Email Address\">\n                        </div>\n                    </div>\n                    <div class=\"field\">\n                        <div class=\"ui left icon input\">\n                            <i class=\"user icon\"></i>\n                            <input\n                            name=\"username\"\n                            v-model=\"username\"\n                            type=\"text\"\n                            placeholder=\"Username\">\n                        </div>\n                    </div>\n                    <div class=\"field\">\n                        <div class=\"ui left icon input\">\n                            <i class=\"lock icon\"></i>\n                            <input\n                            name=\"password\"\n                            v-model=\"password\"\n                            type=\"password\"\n                            placeholder=\"Password\">\n                        </div>\n                    </div>\n                    <div class=\"field\">\n                        <div class=\"ui left icon input\">\n                            <i class=\"lock icon\"></i>\n                            <input\n                            name=\"passwordRepeat\"\n                            v-model=\"passwordRepeat\"\n                            type=\"password\"\n                            placeholder=\"Repeat Password\">\n                        </div>\n                    </div>\n                    \n                    <button class=\"ui fluid large green submit button\" v-bind:class=\"{disabled: loading}\">{{ buttonText }}</button>\n                </div>\n            </form>\n\n            <div class=\"ui message\">\n                Already have an account? <a href=\"/login\">Sign In</a>\n            </div>\n        </div>\n\n    "});Vue.component('top-nav',{props:['session','loaded'],mounted:function mounted(){if(this.session){$("nav .ui.dropdown").dropdown();}},template:"\n    <nav>\n        <ul>\n            <li>\n                <a href=\"/\">Plant Index</a>\n            </li>\n            <li>\n                <a href=\"/my-gardens\">My Gardens</a>\n            </li>\n            <template v-if=\"loaded\">\n                <li v-if=\"!session\" data-float=\"right\">\n                    <a href=\"/login\">Sign In</a>\n                </li>\n                <li v-if=\"session\" data-float=\"right\">\n                    <div class=\"ui pointing dropdown\">\n                        <span class=\"text\">{{ session.username }}</span>\n                        <i class=\"dropdown icon\"></i>\n                        <div class=\"menu\">\n                            <a class=\"item\">User Settings</a>\n                            <div class=\"divider\"></div>\n                            <a class=\"item\" href=\"/logout\">Logout</a>\n                        </div>\n                    </div>\n                </li>\n            </template>\n            <template v-if=\"!loaded\">\n                <li data-float=\"right\"><div class=\"ui active green small inline loader\"></div></li>\n            </template>\n        </ul>\n    </nav>\n    "});Vue.component('user-garden-header',{props:['garden_id'],data:function data(){return{loading:false,garden:false};},methods:{getGarden:function getGarden(garden_id){var _this21=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee29(){var req,res;return _regenerator["default"].wrap(function _callee29$(_context29){while(1){switch(_context29.prev=_context29.next){case 0:_this21.loading=true;_context29.next=3;return fetch("/api/get-garden/"+garden_id);case 3:req=_context29.sent;_context29.next=6;return req.json();case 6:res=_context29.sent;_this21.garden=res;_this21.loading=false;case 9:case"end":return _context29.stop();}}},_callee29);}))();},reload:function reload(){var _this22=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee30(){return _regenerator["default"].wrap(function _callee30$(_context30){while(1){switch(_context30.prev=_context30.next){case 0:if(!_this22.garden_id){_context30.next=3;break;}_context30.next=3;return _this22.getGarden(_this22.garden_id);case 3:case"end":return _context30.stop();}}},_callee30);}))();}},computed:{userOwns:function userOwns(){return this.garden&&app.session._id===this.garden.user_id._id;}},mounted:function(){var _mounted6=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee31(){return _regenerator["default"].wrap(function _callee31$(_context31){while(1){switch(_context31.prev=_context31.next){case 0:_context31.next=2;return this.reload();case 2:case"end":return _context31.stop();}}},_callee31,this);}));function mounted(){return _mounted6.apply(this,arguments);}return mounted;}(),template:"\n    <div>\n        <template v-if=\"!loading\">\n            <h2 class=\"ui icon header center aligned green\">\n                <i class=\"circular seedling icon\"></i>\n                <div class=\"content\">\n                    {{garden.name}}\n                    <div class=\"sub header\">\n                    {{garden.description}}\n                    </div>\n                </div>\n            </h2>\n            <template v-if=\"userOwns\">\n                <add-plant-type v-bind:garden_id=\"garden_id\"></add-plant-type>\n            </template>\n\n        </template>\n        <div class=\"ui divider\"></div>\n    </div>\n    "});Vue.component('user-garden',{props:['garden_id'],template:"\n            <div>\n                <user-garden-header v-bind:garden_id=\"garden_id\"></user-garden-header>\n                <garden-plants ref=\"garden_plants\" v-bind:garden_id=\"garden_id\"></garden-plants>\n            </div>\n        "});Vue.component('user-gardens-header',{props:['user_id'],template:"\n    <div>\n        <h2 class=\"ui icon header center aligned green\">\n            <i class=\"circular tree icon\"></i>\n            <div class=\"content\">\n                My Gardens\n                <div class=\"sub header\">View your gardens or create a new one</div>\n            </div>\n        </h2>\n\n        <create-garden v-bind:user_id=\"user_id\"></create-garden>\n        <div class=\"ui divider\"></div>\n    </div>\n    "});Vue.component('user-gardens',{props:['user_id'],data:function data(){return{loading:false,gardens:false};},methods:{getUserGardens:function getUserGardens(user_id){var _this23=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee32(){var req,res;return _regenerator["default"].wrap(function _callee32$(_context32){while(1){switch(_context32.prev=_context32.next){case 0:_this23.loading=true;_context32.next=3;return fetch("/api/get-user-gardens/"+user_id);case 3:req=_context32.sent;_context32.next=6;return req.json();case 6:res=_context32.sent;_this23.loading=false;if(res.success){_this23.gardens=res.success;}else{$('body').toast({"class":'error',message:"".concat(res.error),displayTime:1000,position:window.innerWidth<=770?"top center":"top right"});}case 9:case"end":return _context32.stop();}}},_callee32);}))();},reload:function reload(){var _this24=this;return(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee33(){return _regenerator["default"].wrap(function _callee33$(_context33){while(1){switch(_context33.prev=_context33.next){case 0:if(!_this24.user_id){_context33.next=3;break;}_context33.next=3;return _this24.getUserGardens(_this24.user_id);case 3:case"end":return _context33.stop();}}},_callee33);}))();}},mounted:function(){var _mounted7=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee34(){return _regenerator["default"].wrap(function _callee34$(_context34){while(1){switch(_context34.prev=_context34.next){case 0:_context34.next=2;return this.reload();case 2:case"end":return _context34.stop();}}},_callee34,this);}));function mounted(){return _mounted7.apply(this,arguments);}return mounted;}(),template:"\n        <div>\n            <div v-if=\"loading\" class=\"loading-text\">\n                <div class=\"ui active large centered inline loader text green\">Loading Gardens...</div>\n            </div>\n            <template v-else-if=\"!loading\">\n                <div v-if=\"gardens && gardens.length\" class=\"gardens-list ui link cards centered\">\n                    <template v-for=\"garden in gardens\">\n                        <garden-item v-bind:garden=\"garden\"></garden-item>\n                    </template>\n                </div>\n                <div class=\"gardens-empty\" v-else-if=\"gardens && !gardens.length\">\n                You have no gardens\n                </div>\n            </template>\n        </div>\n\n    "});
